    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div style="font-size:0.78rem;color:#3F6656;line-height:1.9;">
                ...
                ⚖️ <b>{df_all['Case_No'].nunique():,}</b> unique cases<br>
                👨‍⚖️ <b>{df_all['Judge_Short'].nunique()}</b> judges<br>
        ...
        <div class="top-banner">
            <div class="banner-left">
                ...
                <div>
                    ...
                    <div class="banner-subtitle">Judicial Intelligence Platform — Sindh High Court | Section 1AD</div>
                </div>
            </div>
